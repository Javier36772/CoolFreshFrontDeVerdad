...
export function Alertas() {
  ...
  useEffect(() => {
    const fetchAlertas = async () => {
      try {
        const response = await fetch(`https://coolfresh-api.freemyip.com/Notificacion`);
  ...
  const deleteAlerta = async (id_Notificaciones) => {
    try {
      ...
      const response = await fetch(`https://coolfresh-api.freemyip.com/Notificacion/${id_Notificaciones}`, {
        method: "DELETE",
      });
